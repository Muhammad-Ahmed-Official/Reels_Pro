      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 dark:bg-black/70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-4xl max-h-[90vh] bg-white dark:bg-gray-900 rounded-lg shadow-xl overflow-hidden">
            {/* Close Button */}
            <button
              className="absolute top-3 right-3 z-10 p-2 text-gray-600 hover:text-gray-900 cursor-pointer dark:text-gray-300 dark:hover:text-white bg-white/80 dark:bg-gray-800/80 rounded-full backdrop-blur-sm transition-colors"
              onClick={() => setIsModalOpen(false)}
              disabled={isSubmitting}
            >
              <X className="w-4 h-4 sm:w-5 sm:h-5" />
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              {currentStep === 1 && (
                <div className="space-y-4 sm:space-y-6">
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 sm:p-8 text-center cursor-pointer hover:border-gray-400 dark:hover:border-gray-500 transition-colors">
                    <Video className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 text-gray-400" />
                    <h4 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">
                      Upload Your Video
                    </h4>
              ...
              {currentStep === 2 && (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="w-full lg:w-3/5 space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          maxLength={100}
                          {...register("title")}
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-white"
                        />
                        {errors.title && (
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          maxLength={500}
                          {...register("description")}
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-white h-24 resize-none"
                        />
                        {errors.description && (
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-3 border-t pt-4">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50 transition-colors text-sm font-medium flex items-center justify-center gap-2"
                      disabled={isSubmitting}
                    >
                      {isSubmitting ? (
                        <>
